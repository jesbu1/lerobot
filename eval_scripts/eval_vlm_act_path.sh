...
#policy_path="outputs/train_act_libero_path_vlm_test_5ep/checkpoints/last/pretrained_model"
policy_path="outputs/train_act_libero_path_vlm_new/checkpoints/last/pretrained_model"
