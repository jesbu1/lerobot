...
RESUME=true
policy_path="outputs/train_act_libero_path_mask_vlm/checkpoints/last/pretrained_model"
libero_envs="libero_goal libero_spatial libero_10 libero_object"

for env in $libero_envs; do
    name="eval_vlm_act_$env"
    CMD="python lerobot/scripts/eval_libero_vlm.py \
        --env.type=libero \
