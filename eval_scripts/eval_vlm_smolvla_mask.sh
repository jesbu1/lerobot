...
#policy_path="outputs/train_smolvla_libero_path_mask_vlm_test_5ep/checkpoints/last/pretrained_model"
policy_path="outputs/train_smolvla_libero_path_mask_vlm_new/checkpoints/last/pretrained_model"
...
for env in $libero_envs; do
    for mask_ratio in 0.08; do
        ...
        #name="eval_vlm_smolvla_pathmask_test_5ep_${mask_ratio}mask_$env"
        #group="eval_vlm_smolvla_pathmask_test_5ep_${mask_ratio}mask"
        name="eval_vlm_smolvla_pathmask_90_${mask_ratio}mask_$env"
        group="eval_vlm_smolvla_pathmask_90_${mask_ratio}mask"
