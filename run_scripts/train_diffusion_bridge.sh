...
EXP_NAME=train_diffusion_bridge_resnetscratch
PROJ_NAME=lerobot

BASE_TRAIN_CMD="--config_path=train_configs/train_diffusion_bridge.yaml --output_dir=outputs/$EXP_NAME --job_name=$EXP_NAME --wandb.run_id=$EXP_NAME"
