...
EXP_NAME=train_act_libero_path_mask_vlm_test_5ep
PROJ_NAME=lerobot
RESUME=false

BASE_TRAIN_CMD="--config_path=train_configs/train_act_libero_path_mask_vlm.yaml --output_dir=outputs/$EXP_NAME --job_name=$EXP_NAME --wandb.run_id=$EXP_NAME --dataset.repo_id=jesbu1/libero_test_lerobot_pathmask_vlm_preds_max_ep_per_task_5"
