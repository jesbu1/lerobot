...
EXP_NAME=train_smolvla_libero_path_mask_vlm_centered_0.1mask_nowrist
PROJ_NAME=lerobot

BASE_TRAIN_CMD="--config_path=train_configs/train_smolvla_libero_path_mask_vlm_centered_nowrist.yaml --wandb.run_id=$EXP_NAME --output_dir=outputs/$EXP_NAME --job_name=$EXP_NAME"
