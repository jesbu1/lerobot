...
EXP_NAME=train_act_libero_path_mask_vlm_centered_0.1mask_nowrist
PROJ_NAME=lerobot
RESUME=false

BASE_TRAIN_CMD="--config_path=train_configs/train_act_libero_path_mask_vlm_centered_nowrist.yaml --output_dir=outputs/$EXP_NAME --job_name=$EXP_NAME --wandb.run_id=$EXP_NAME"
