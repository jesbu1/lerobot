...
EXP_NAME=train_smolvla_libero_path
PROJ_NAME=lerobot

BASE_TRAIN_CMD="--config_path=train_configs/train_smolvla_libero_path.yaml --wandb.run_id=$EXP_NAME"
RESUME_TRAIN_CMD="--config_path=outputs/train_smolvla_libero_path/checkpoints/last/pretrained_model/train_config.json --resume=true"
