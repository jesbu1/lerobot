...
BASE_TRAIN_CMD="--config_path=train_configs/train_smolvla_bridge.yaml --wandb.run_id=$EXP_NAME"
RESUME_TRAIN_CMD="--config_path=outputs/train_smolvla_bridge/checkpoints/last/pretrained_model/train_config.json --resume=true"
